-- niceandclean, awesome3 theme, by Blazeix, 
-- based off of ghost1227's openbox theme.
-- modified to include some dust theme settings

local awful = require("awful")

-- {{{ Helpers
function hometheme(path) return awful.util.getdir("config") .. "/themes/glow" .. path end
...
theme.fg_urgent     = "#12c18d"
theme.fg_tooltip    = "#1f1f1f"
theme.fg_em         = "#ffffff"
theme.fg_widget        = "#12c18d"
theme.fg_center_widget = "#0d906a"
theme.fg_end_widget    = theme.fg_tooltip

theme.bg_normal     = theme.fg_tooltip
theme.bg_focus      = "#262626"
theme.bg_urgent     = "#12c18d"
